...
map zu :set nosplitbelow  <CR>:split <CR>  "往上分屏
map zn :set splitbelow    <CR>:split <CR>  "往下分屏
map zd :set nosplitright  <CR>:vsplit<CR>  "往左分屏
map zl :set splitright    <CR>:vsplit<CR>  "往右分屏

" Place the two screens up and down
map zm <C-w>t<C-w>K  "左右切至上下分屏
" Place the two screens side by side
map zk <C-w>t<C-w>H  "上下切至左右分屏
